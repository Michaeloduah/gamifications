...
<div class="container">
    ...
    <form class="border rounded p-5" id="form" enctype="multipart/form-data" method="POST" action="{{ route('questions.store') }}" >
        @csrf
        <div class="mb-3">
...
<div class="container">
    ...
    <form class="border rounded p-5" id="form" enctype="multipart/form-data" method="POST" action="" >
        ...
        <div class="mb-3">
            ...
            <select name="answer" id="course" class="form-control">
